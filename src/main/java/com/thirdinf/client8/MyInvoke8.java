...
public class MyInvoke8 implements BaseInvokeInf {
   private static final Logger logger = Logger.getLogger(MyInvoke8.class);
   ...
   public String checkQrAndAddress(String requestUrl, LinkedHashMap<String, Object> map) {
      ...
      MyCheckRequestData8 requestData = new MyCheckRequestData8();
   ...
   MyCheckRequestData8 createTestData() {
      Integer station = 1;
      Integer number = 1;
