...
@Component
public class MyJob8 implements MyInf8, Runnable, ApplicationListener<MyEvent> {
   private static final Logger logger = Logger.getLogger(MyJob8.class);
   @Autowired
   ...
   public boolean sendData(Tbldata d, Tblclient client) {
      boolean bOk = true;
      MyRequestData8 request = new MyRequestData8();
      ...
      try {
         ...
         MyResponseData8 myResponseData = (MyResponseData8)objectMapper.readValue(jsonString, MyResponseData8.class);
         MyLog8.showCode2(myResponseData.getCode());
   ...
   MyRequestData8 crteateTestData() {
      MyRequestData8 request = new MyRequestData8();
