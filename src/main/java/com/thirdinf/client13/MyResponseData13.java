...
public class MyResponseData13 {
   ...
   public String toString() {
      return "MyResponseData13{callBackID='" + this.callBackID + '\'' + ", dataIdentity='" + this.dataIdentity + '\'' + ", retCode='" + this.retCode + '\'' + ", retMsg='" + this.retMsg + '\'' + ", body=" + this.body + '}';
   }
