...
public class MyCheckRequestDataEx13 {
   ...
   public String toString() {
      return "MyCheckRequestDataEx13{dataIdentity='" + this.dataIdentity + '\'' + ", sign='" + this.sign + '\'' + ", commandID='" + this.commandID + '\'' + ", data=" + this.data + '}';
   }
}
