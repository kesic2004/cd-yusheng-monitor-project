...
@Component
public class MyJob13 implements MyInf13, Runnable, ApplicationListener<MyEvent> {
   private static final Logger logger = Logger.getLogger(MyJob13.class);
   @Autowired
   ...
   public boolean sendData(Tbldata d, Tblclient client) {
      ...
      MyRequestData13 request = new MyRequestData13();
      MyRequestDataEx13 requestEx = new MyRequestDataEx13();
      ...
      try {
         ...
         MyResponseData13 myResponseData = (MyResponseData13)objectMapper.readValue(jsonString, MyResponseData13.class);
