...
public class MyInvoke16 implements BaseInvokeInf {
   private static final Logger logger = Logger.getLogger(MyInvoke16.class);
   ...
   public String checkQrAndAddress(String requestUrl, LinkedHashMap<String, Object> map) {
      ...
      MyCheckRequestData16 requestData = new MyCheckRequestData16();
   ...
   MyCheckRequestData16 createTestData() {
      Integer station = 1;
      Integer number = 1;
   ...
   public Integer parseData(String jsonString) {
      ...
      try {
         ObjectMapper objectMapper = new ObjectMapper();
         MyCheckResponseData16 myResponseData = (MyCheckResponseData16)objectMapper.readValue(jsonString, MyCheckResponseData16.class);
         logger.info("-> parse check result data: " + myResponseData.toString());
         MyLog16.showCode(myResponseData.getCode());
