...
@Component
public class MyJob16 implements MyInf16, Runnable, ApplicationListener<MyEvent> {
   private static final Logger logger = Logger.getLogger(MyJob16.class);
   @Autowired
   ...
   public boolean sendData(Tbldata d, Tblclient client) {
      boolean bOk = true;
      MyRequestData16 request = new MyRequestData16();
      ...
      try {
         ...
         MyResponseData16 myResponseData = (MyResponseData16)objectMapper.readValue(jsonString, MyResponseData16.class);
         MyLog16.showCode2(myResponseData.getCode());
   ...
   MyRequestData16 crteateTestData() {
      MyRequestData16 request = new MyRequestData16();
