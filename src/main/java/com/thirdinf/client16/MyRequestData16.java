...
public class MyRequestData16 {
   ...
   public String toString() {
      return "MyRequestData15{station_num='" + this.station_num + '\'' + ", number='" + this.number + '\'' + ", start_time='" + this.start_time + '\'' + ", end_time='" + this.end_time + '\'' + ", record_voucher='" + this.record_voucher + '\'' + ", jz='" + this.jz + '\'' + ", pz='" + this.pz + '\'' + ", zz='" + this.zz + '\'' + ", sz='" + this.sz + '\'' + ", peop_num='" + this.peop_num + '\'' + '}';
   }
}
