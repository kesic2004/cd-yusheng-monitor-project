...
@Component
public class MyJob10 implements MyInf10, Runnable, ApplicationListener<MyEvent> {
   private static final Logger logger = Logger.getLogger(MyJob10.class);
   @Autowired
   ...
   public boolean sendData(Tbldata d, Tblclient client) {
      ...
      MyRequestData10 request = new MyRequestData10();
      MyRequestDataEx10 requestEx = new MyRequestDataEx10();
      ...
      try {
         ...
         MyResponseData10 myResponseData = (MyResponseData10)objectMapper.readValue(jsonString, MyResponseData10.class);
         MyLog10.showCode2(myResponseData.getRetCode());
