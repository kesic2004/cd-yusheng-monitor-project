...
public class MyCheckRequestDataEx10 {
   ...
   public String toString() {
      return "MyCheckRequestDataEx10{dataIdentity='" + this.dataIdentity + '\'' + ", sign='" + this.sign + '\'' + ", commandID='" + this.commandID + '\'' + ", data=" + this.data + '}';
   }
}
