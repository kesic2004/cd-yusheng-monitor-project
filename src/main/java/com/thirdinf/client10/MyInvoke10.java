...
public class MyInvoke10 implements BaseInvokeInf {
   private static final Logger logger = Logger.getLogger(MyInvoke10.class);
   ...
   public String checkQrAndAddress(String requestUrl, LinkedHashMap<String, Object> map) {
      ...
      MyCheckRequestData10 requestData = new MyCheckRequestData10();
      MyCheckRequestDataEx10 requestDataEx = new MyCheckRequestDataEx10();
      Data data = new Data();
   ...
   public Integer parseData(String jsonString) {
      ...
      try {
         ObjectMapper objectMapper = new ObjectMapper();
         MyCheckResponseData10 myResponseData = (MyCheckResponseData10)objectMapper.readValue(jsonString, MyCheckResponseData10.class);
         logger.info("-> parse check result data: " + myResponseData.toString());
         MyLog10.showCode(myResponseData.getRetCode());
