...
public class MyInvoke15 implements BaseInvokeInf {
   private static final Logger logger = Logger.getLogger(MyInvoke15.class);
   ...
   public String checkQrAndAddress(String requestUrl, LinkedHashMap<String, Object> map) {
      ...
      MyCheckRequestData15 requestData = new MyCheckRequestData15();
      MyCheckRequestDataEx15 requestDataEx = new MyCheckRequestDataEx15();
      Data data = new Data();
   ...
   public Integer parseData(String jsonString) {
      ...
      try {
         ...
         MyCheckResponseData15 myResponseData = (MyCheckResponseData15)objectMapper.readValue(jsonString, MyCheckResponseData15.class);
         logger.info("-> parse check result data: " + myResponseData.toString());
         MyLog15.showCode(myResponseData.getRetCode());
