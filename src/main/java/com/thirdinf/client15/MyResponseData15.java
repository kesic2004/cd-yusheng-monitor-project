...
public class MyResponseData15 {
   ...
   public String toString() {
      return "MyResponseData15{callBackID='" + this.callBackID + '\'' + ", dataIdentity='" + this.dataIdentity + '\'' + ", retCode='" + this.retCode + '\'' + ", retMsg='" + this.retMsg + '\'' + ", body=" + this.body + '}';
   }
