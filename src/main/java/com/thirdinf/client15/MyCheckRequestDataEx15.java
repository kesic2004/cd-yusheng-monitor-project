...
public class MyCheckRequestDataEx15 {
   ...
   public String toString() {
      return "MyCheckRequestDataEx15{dataIdentity='" + this.dataIdentity + '\'' + ", sign='" + this.sign + '\'' + ", commandID='" + this.commandID + '\'' + ", data=" + this.data + '}';
   }
}
