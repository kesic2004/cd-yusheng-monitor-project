...
public class MyCheckResponseData15 {
   ...
   public String toString() {
      return "MyCheckResponseData15{callBackID=" + this.callBackID + ", retCode='" + this.retCode + '\'' + ", retMsg='" + this.retMsg + '\'' + ", dataIdentity='" + this.dataIdentity + '\'' + ", body=" + this.body + '}';
   }
}
