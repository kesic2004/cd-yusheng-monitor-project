...
@Component
public class MyJob2 implements MyInf2, Runnable, ApplicationListener<MyEvent> {
   ...
   public boolean sendData(Tbldata d, Tblclient client) {
      boolean bOk = true;
      MyRequestData2 request = new MyRequestData2();
      ...
      try {
         ...
         MyResponseData2 myResponseData = (MyResponseData2)objectMapper.readValue(jsonString, MyResponseData2.class);
         MyLog2.showCode2(myResponseData.getCode());
   ...
   MyRequestData2 crteateTestData() {
      MyRequestData2 request = new MyRequestData2();
