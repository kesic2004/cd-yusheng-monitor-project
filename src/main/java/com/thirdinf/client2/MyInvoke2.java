...
public class MyInvoke2 implements BaseInvokeInf {
   private static final Logger logger = Logger.getLogger(MyInvoke2.class);
   ...
   public String checkQrAndAddress(String requestUrl, LinkedHashMap<String, Object> map) {
      ...
      MyCheckRequestData2 requestData = new MyCheckRequestData2();
   ...
   MyCheckRequestData2 createTestData() {
      Integer station = 1;
      Integer number = 1;
   ...
   public Integer parseData(String jsonString) {
      ...
      try {
         ObjectMapper objectMapper = new ObjectMapper();
         MyCheckResponseData2 myResponseData = (MyCheckResponseData2)objectMapper.readValue(jsonString, MyCheckResponseData2.class);
         logger.info("-> parse check result data: " + myResponseData.toString());
         MyLog2.showCode(myResponseData.getCode());
