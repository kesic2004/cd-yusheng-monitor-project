...
public class MyInvoke3 implements BaseInvokeInf {
   private static final Logger logger = Logger.getLogger(MyInvoke3.class);
   ...
   public String checkQrAndAddress(String requestUrl, LinkedHashMap<String, Object> map) {
      ...
      MyCheckRequestData3 requestData = new MyCheckRequestData3();
   ...
   MyCheckRequestData3 createTestData() {
      Integer station = 1;
      Integer number = 1;
   ...
   public Integer parseData(String jsonString) {
      ...
      try {
         ObjectMapper objectMapper = new ObjectMapper();
         MyCheckResponseData3 myResponseData = (MyCheckResponseData3)objectMapper.readValue(jsonString, MyCheckResponseData3.class);
         logger.info("-> parse check result data: " + myResponseData.toString());
         MyLog3.showCode(myResponseData.getCode());
