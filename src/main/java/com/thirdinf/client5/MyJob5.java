...
@Component
public class MyJob5 implements MyInf5, Runnable, ApplicationListener<MyEvent> {
   private static final Logger logger = Logger.getLogger(MyJob5.class);
   @Autowired
   ...
   public boolean sendData(Tbldata d, Tblclient client) {
      boolean bOk = true;
      MyRequestData5 request = new MyRequestData5();
      ...
      request.setKhbh(d.getClientid().toString());
      ...
      try {
         ...
         MyResponseData5 myResponseData = (MyResponseData5)objectMapper.readValue(jsonString, MyResponseData5.class);
         MyLog5.showCode2(myResponseData.getCode());
   ...
   MyRequestData5 crteateTestData(MyRequestData5 request) {
      return request;
   }
