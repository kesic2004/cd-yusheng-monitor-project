...
public class MyRequestData5 {
   ...
   public String toString() {
      return "MyRequestData5{station_num='" + this.station_num + '\'' + ", number='" + this.number + '\'' + ", start_time='" + this.start_time + '\'' + ", end_time='" + this.end_time + '\'' + ", record_voucher='" + this.record_voucher + '\'' + ", jz='" + this.jz + '\'' + ", pz='" + this.pz + '\'' + ", zz='" + this.zz + '\'' + ", sz='" + this.sz + '\'' + ", khbh='" + this.khbh + '\'' + ", fs='" + this.fs + '\'' + ", peop_num='" + this.peop_num + '\'' + '}';
   }
}
