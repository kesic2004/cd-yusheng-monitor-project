...
@Component
public class MyJob14 implements MyInf14, Runnable, ApplicationListener<MyEvent> {
   private static final Logger logger = Logger.getLogger(MyJob14.class);
   @Autowired
   ...
   public boolean sendData(Tbldata d, Tblclient client) {
      ...
      MyRequestData14 request = new MyRequestData14();
      MyRequestDataEx14 requestEx = new MyRequestDataEx14();
      ...
      try {
         ...
         MyResponseData14 myResponseData = (MyResponseData14)objectMapper.readValue(jsonString, MyResponseData14.class);
