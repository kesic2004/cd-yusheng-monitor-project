...
public class MyInvoke14 implements BaseInvokeInf {
   private static final Logger logger = Logger.getLogger(MyInvoke14.class);
   ...
   public String checkQrAndAddress(String requestUrl, LinkedHashMap<String, Object> map) {
      ...
      MyCheckRequestData14 requestData = new MyCheckRequestData14();
      MyCheckRequestDataEx14 requestDataEx = new MyCheckRequestDataEx14();
      Data data = new Data();
   ...
   public Integer parseData(String jsonString) {
      ...
      try {
         ...
         MyCheckResponseData14 myResponseData = (MyCheckResponseData14)objectMapper.readValue(jsonString, MyCheckResponseData14.class);
         logger.info("-> parse check result data: " + myResponseData.toString());
         MyLog14.showCode(myResponseData.getRetCode());
