...
public class MyRequestData9 {
   ...
   public String toString() {
      return "MyRequestData9{station_num='" + this.station_num + '\'' + ", number='" + this.number + '\'' + ", start_time='" + this.start_time + '\'' + ", end_time='" + this.end_time + '\'' + ", record_voucher='" + this.record_voucher + '\'' + ", jz='" + this.jz + '\'' + ", pz='" + this.pz + '\'' + ", zz='" + this.zz + '\'' + ", sz='" + this.sz + '\'' + ", fs='" + this.fs + '\'' + ", worker='" + this.worker + '\'' + '}';
   }
}
